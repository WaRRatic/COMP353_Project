...
CREATE  TABLE kpc353_2.members ( 
 ...
 ) QENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ciE;
...
ALTER TABLE kpc353_2.group_members MODIFY date_joined DATE  NOT NULL   COMMENT 'the date when a particular member has joned a particular group';

ALTER TABLE kpc353_2.group_members MODIFY group_member_status ENUM('member','owner','requested','ousted')   DEFAULT ('member')  COMMENT 'the status of a particular member in a particular group
