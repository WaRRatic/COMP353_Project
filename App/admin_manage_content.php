...
$sql = "SELECT
content_id, creator_id, content_type, content_data, content_creation_date, content_title, moderation_status, content_deleted_flag
FROM
content
where content_deleted_flag = false";
    ...
    <table border="1">
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<td>";
                echo "<td><a href='admin_moderate_specific_content.php?content_id=" . $row['content_id'] . "'><button>Moderate</button></a></td>";
                echo "</form>";
                echo "</td>";
                echo "</tr>";
            }
