...
//get received gifts
$sql = "SELECT 
        grg.gift_id, grg.gift_status, gri.gift_idea_description, gr.gift_registry_name, m.username as sender_name, grg.gift_date
        FROM gift_registry_gifts grg
        JOIN gift_registry_ideas gri ON grg.gift_registry_idea_id = gri.gift_registry_ideas_id
        JOIN gift_registry gr ON grg.sender_member_id = m.member_id
